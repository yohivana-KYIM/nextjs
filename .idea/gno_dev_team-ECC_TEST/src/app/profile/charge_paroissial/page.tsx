...
function page() {
  ...
  return (
    <div className="w-full min-h-screen bg-white overflow-x-hidden">
        ...
        <h1 className="font-semibold text-2xl md:text-4xl text-zinc-800">Découvrez nos Chargés Paroissiaux </h1>
        ...
        <div className="flex flex-col md:flex-row items-center justify-center w-full md:my-6 p-3">
          <input className="w-full md:w-1/3 border-gray-300 mt-1 border form-input p-2 outline-none block rounded-lg shadow-sm" type="text" placeholder="Nom du charge paroissial" />
